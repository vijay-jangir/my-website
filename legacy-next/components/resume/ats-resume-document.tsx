...
export default function AtsResumeDocument({ variant }: AtsResumeDocumentProps) {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <Text style={styles.meta}>
            {siteProfile.email} | {siteProfile.location} |{" "}
            {siteProfile.githubUrl} | {siteProfile.linkedinUrl}
          </Text>
        </View>
